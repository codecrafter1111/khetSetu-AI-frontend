...
export default function RecentOrders() {
  return <Card className="h-full min-w-0 p-4 xl:flex xl:flex-col xl:justify-between">
    ...
    {orders.map(order => <div key={order.id} className="grid grid-cols-[1fr_auto] items-center gap-2 border-b border-slate-200/80 py-3.5 last:border-0 min-[700px]:grid-cols-[1.6fr_.75fr_.95fr_.9fr_.65fr] min-[700px]:gap-1 min-[700px]:px-2">
