...
export const consumerOrders = [
  ...
  { id: 'KS6892', placedAt: '2025-04-05', status: 'processing', statusLabel: 'Processing', statusDate: 'Expected by Apr 08, 2025', farm: 'GreenFields Farm', location: 'Karnataka', total: 380, subtotal: 340, deliveryCharge: 40, discount: 0, savings: 100, paidWith: 'Card', imageTile: 5, summary: 'Mixed Pulses, Masoor Dal + 2 more', items: [item(6, 'Mixed Pulses', '1 kg'), item(6, 'Masoor Dal', '500 g'), item(6, 'Moong Dal', '500 g'), item(6, 'Toor Dal', '500 g')] },
